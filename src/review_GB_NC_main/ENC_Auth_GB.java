...
//		driver = new ChromeDriver();
	...
	@Test(priority=0)
	public void ENC_Wlcmpage() throws IOException, InterruptedException 
	{

		Step02_ENC_GB login = new Step02_ENC_GB(driver);
		login.loginENC();
	}
	@Test(priority=1)
	public void ENC_reqopen() 
	{
		...
		Step02_ENC_GB encopen = new Step02_ENC_GB(driver);
	...
	public void ENC_auth() 
	{
		...
		Step02_ENC_GB encauth = new Step02_ENC_GB(driver);
		encauth.submit_req();
	}
}
